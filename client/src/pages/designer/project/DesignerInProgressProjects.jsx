...
import { getDesignerInProgressProjects } from "../../../features/actions/designerActions";
...
const DesignerInProgressProjects = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (getDesignerInProgressProjects.rejected.match(actionResult)) {
...
export default DesignerInProgressProjects;
