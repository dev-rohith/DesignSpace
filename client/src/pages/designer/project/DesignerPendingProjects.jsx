...
import { getDesignerPendingProjects } from "../../../features/actions/designerActions";
    ...
    (async () => {
      const actionResult = await dispatch(
        getDesignerPendingProjects(
          `/projects/designer/pending?${searchParams.toString()}`
        )
      );
      if (getDesignerPendingProjects.rejected.match(actionResult)) {
...
export default DesignerPendingProjects;
