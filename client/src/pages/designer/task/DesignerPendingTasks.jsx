...
import { getDesignerPendingTasks } from "../../../features/actions/taskActions";
  ...
  return (
    <div className="min-h-screen overflow-y-auto w-screen px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage and track your pending tasks</p>
      </div>
...
export default DesignerPendingTasks;
