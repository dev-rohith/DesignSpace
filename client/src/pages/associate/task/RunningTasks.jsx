...
import { getAssocaiteTasks } from "../../../features/actions/taskActions";
...
const RunningTasks = () => {
  ...
  useEffect(() => {
    (async () => {
      const actionResult = await dispatch(getAssocaiteTasks(`/tasks/associate/inprogress?${searchParams.toString()}`));
      if(getAssocaiteTasks.rejected.match(actionResult)){
  ...
  <div className="min-h-screen overflow-y-auto w-screen px-4 sm:px-6 lg:px-8 py-8">
    <div className="mb-8">
      ...
      <p className="text-gray-600">Manage, track and update your working tasks</p>
    </div>
