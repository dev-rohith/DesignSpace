...
const CompletedTasks = () => {
  ...
  useEffect(() => {
    (async () => {
      const actionResult = await dispatch(getAssocaiteTasks(`/tasks/associate/completed?${searchParams.toString()}`));
  ...
  <div className="min-h-screen overflow-y-auto w-screen px-4 sm:px-6 lg:px-8 py-8">
    <div className="mb-8">
      ...
      <p className="text-gray-600">Manage and track your completed tasks</p>
    </div>
