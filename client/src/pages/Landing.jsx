            ...
            <div className="flex justify-around  items-center">
              <div className="w-full ml-2 hidden md:block">
                <div className="text-center my-12 font-sansita">
                  <h3 className="uppercase text-2xl font-bold text-gray-700 pb-3">
                  Customer Happiness is What Drives Us!
                  </h3>
                  <p className="text-gray-600">"Customer happiness isn’t just about satisfaction; it’s about creating experiences that make them come back and bring others with them." 😊</p>
                </div>
              ...
              <div className="w-full">
                <div className="text-center mt-12 font-sansita">
