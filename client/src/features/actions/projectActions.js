...
export const updateProjectDetails = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.put(`/projects/${data.id}`, data.formData);
...
export const updateProjectProgress = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.put(`/projects/progress/${data.id}`, data.formData);
      console.log(response.data);
      return response.data;
    } catch (error) {
      console.log(error.response.data)
...
export const addBeforeProjectToPortfolio = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    console.log(data)
    try {
      const response = await axiosInstance.put(`/projects/before/${data._id}`, data.formData);
      console.log(response.data);
      return response.data;
    } catch (error) {
      console.log(error.response.data)
...
export const deleteBeforeProjectToPortifolio = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.delete(`/projects/before/${data.projectId}/item/${data.itemId}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
...
export const deleteAfterProjectToPortifolio = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.delete(`/projects/after/${data.projectId}/item/${data.itemId}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
